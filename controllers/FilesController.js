...
/**
 * This is a filesController class to manage user files
 */
class FilesController {
  /**
   * This handles uploading a file by creating a new File object and saving it to the database.
  ...
  /**
   * This returns a JSON response containing a file with the given id, if it belongs to the current user.
   * @param {Object} request - the HTTP request object
   * @param {Object} response - the HTTP response object
   * @return {Promise<Object>} - a JSON response containing the file, or an error message.
   */
  ...
  /**
   * This retrieves a list of files belonging to the current user, filtered by `parentId` and `page`.
   ...
   * @return {Object} The HTTP response object with status code 200 and a JSON array of files.
   */
  ...
  /**
   * This executes an asynchronous method to publish a file.
  ...
  /**
   * This executes an asynchronous method to unpublish a file.
  ...
  /**
   * This updates the publication status of a file.
   * @param {Object} request - The HTTP request object.
   * @param {Object} response - The HTTP response object.
  ...
  /**
   * This retrieves a file from the server given a file id and sends it as a response
   * @param {Object} request - The HTTP request object.
   * @param {Object} response - The HTTP response object.
